...
public class BridgeCore {
    ...
    public static final String ACTION_START = "com.aurea.print.START";
    public static final String ACTION_STOP = "com.aurea.print.STOP";
    public static final String ACTION_ONCE = "com.aurea.print.ONCE";
    public static final UUID SPP_UUID = UUID.fromString("00001101-0000-1000-8000-00805F9B34FB");
    public static final Charset PRINTER_CHARSET = Charset.forName("CP437");
    public static final String KEY_ERROR_ACTIVE = "error_active";
    public static final String KEY_LAST_ERROR = "last_error_message";
    public static final String KEY_LAST_ERROR_TIME = "last_error_time";
    public static final String KEY_LAST_ERROR_JOB = "last_error_job_id";

    public static SharedPreferences prefs(Context ctx) {
        return ctx.getSharedPreferences(PREFS, Context.MODE_PRIVATE);
    }

    public static void setLocalError(Context ctx, String jobId, String message) {
        String msg = message == null ? "Error de impresión" : message;
        prefs(ctx).edit()
                .putBoolean(KEY_ERROR_ACTIVE, true)
                .putString(KEY_LAST_ERROR, msg)
                .putString(KEY_LAST_ERROR_TIME, now())
                .putString(KEY_LAST_ERROR_JOB, jobId == null ? "" : jobId)
                .putString("last_status", "ERROR DE IMPRESIÓN: " + msg)
                .apply();
    }

    public static void clearLocalError(Context ctx) {
        prefs(ctx).edit()
                .putBoolean(KEY_ERROR_ACTIVE, false)
                .putString(KEY_LAST_ERROR, "")
                .putString(KEY_LAST_ERROR_TIME, "")
                .putString(KEY_LAST_ERROR_JOB, "")
                .apply();
    }

    public static boolean hasLocalError(Context ctx) {
        return prefs(ctx).getBoolean(KEY_ERROR_ACTIVE, false);
    }
    ...
    public static int pollAndPrintOnce(Context ctx, Logger logger) throws Exception {
        ...
        for (int i = 0; i < jobs.length(); i++) {
            ...
            if (mac.isEmpty()) {
                ...
                setLocalError(ctx, id, msg);
                logger.log("ERROR DE IMPRESIÓN job=" + id + " - " + msg);
                continue;
            }
            ...
            try {
                ...
                markJob(base, token, id, "error", msg, deviceId);
                setLocalError(ctx, id, msg);
                logger.log("ERROR DE IMPRESIÓN job=" + id + " área=" + area + ": " + msg);
            }
        }
        return printed;
    }
